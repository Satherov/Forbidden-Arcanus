...
public class ModEnhancerDefinitions extends DatapackRegistryClass<EnhancerDefinition> {
    ...
    public void bootstrap(BootstrapContext<EnhancerDefinition> context) {
        context.register(ARTISAN_RELIC, EnhancerDefinition.create(this.generateDescription("artisan_relic", EnhancerTarget.HEPHAESTUS_FORGE, EnhancerTarget.CLIBANO), ModItems.ARTISAN_RELIC.get(), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.EXPERIENCE, 0.75))));
        context.register(CRESCENT_MOON, EnhancerDefinition.create(this.generateDescription("crescent_moon", EnhancerTarget.HEPHAESTUS_FORGE), ModItems.CRESCENT_MOON.get(), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.AUREAL, 0.9), new TimeCondition(23000, 23999)), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.AUREAL, 0.9), new TimeCondition(0, 12999)), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.AUREAL, 0.99), new TimeCondition(13000, 22999))));
        context.register(CRIMSON_STONE, EnhancerDefinition.create(this.generateDescription("crimson_stone", EnhancerTarget.HEPHAESTUS_FORGE, EnhancerTarget.CLIBANO), ModItems.CRIMSON_STONE.get(), this.effect(new MultiplyRequiredEssenceEffect( EssenceType.SOULS, 0.5)), this.effect(new MultiplySoulDurationEffect(1.3D))));
        context.register(SOUL_CRIMSON_STONE, EnhancerDefinition.create(this.generateDescription("soul_crimson_stone", EnhancerTarget.HEPHAESTUS_FORGE), ModItems.SOUL_CRIMSON_STONE.get(), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.AUREAL, 0.0)), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.SOULS, 0.0)), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.BLOOD, 0.0)), this.effect(new MultiplyRequiredEssenceEffect(EssenceType.EXPERIENCE, 0.0))));
