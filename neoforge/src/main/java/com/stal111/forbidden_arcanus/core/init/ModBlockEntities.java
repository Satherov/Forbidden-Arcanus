...
public class ModBlockEntities implements RegistryClass {
    ...
    public static final RegistryEntry<BlockEntityType<?>, BlockEntityType<ArcaneCrystalObeliskBlockEntity>> ARCANE_CRYSTAL_OBELISK = HELPER.register("arcane_crystal_obelisk", () -> BlockEntityType.Builder.of(ArcaneCrystalObeliskBlockEntity::new, ModBlocks.ARCANE_CRYSTAL_OBELISK.get(), ModBlocks.CORRUPTED_ARCANE_CRYSTAL_OBELISK.get()).build(null));
